...
Finally... Support Vector Machines were highly recommended for multinomial classification problems. So it was really higly successfull with %94 percent accuracy in the train set and it got 1 error out of 20 classes in the test set. This one again took around 10 minutes to run with my RStudio on Amazon EC2 MicroMachine which has 1gb ram.
